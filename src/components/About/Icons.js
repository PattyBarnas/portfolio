    ...
    <div className="skills">
      ...
      <div>
        <div className="logo-container">
          <div className="col icons react">
            <ion-icon name="logo-react"> </ion-icon>
            <p>React </p>
          </div>
          <div className="col icons javascript">
            <ion-icon name="logo-javascript"></ion-icon>
            <p>JavaScript</p>
          </div>
          <div className="col icons css">
            <ion-icon name="logo-css3"></ion-icon>
            <p>CSS3/SCSS </p>
          </div>
          <div className="col icons node">
            <ion-icon name="logo-nodejs"></ion-icon>
            <p>Node.js</p>
          </div>
          <div className="col icons express">
          ...
          <div className="col icons mongodb">
            <svg
          ...
          <div className="col icons github">
