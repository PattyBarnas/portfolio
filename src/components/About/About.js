        ...
        <div className={`about-me ${visible ? "about-me-animate" : ""}`}>
          <div>
            ...
            <p className="about-me-description">
              ...
              Computer Science from Governors State University. What sets my
              work apart is the intersection of two disciplines: full-stack
              engineering and technical SEO. I build fast, scalable applications
              using React, Next.js, Node.js, PHP, Java, and Spring Boot
            </p>
            <p className="about-me-description">
              I don't stop at "does it work." I dig into Core Web Vitals and
              site architecture to make sure what I build actually gets
              discovered. That's driven real results: a 225% increase in organic
              traffic, a 40% reduction in ad costs with 300%+ ROAS, and a 350+
              page site migration without losing SEO equity. I'm also a
              certified Salesforce Administrator and Platform Developer I, and
              I've led Agile teams through sprint planning and delivery. I lean
              heavily on AI tools to accelerate my learning and stay current in
              a field that moves fast.
            </p>
