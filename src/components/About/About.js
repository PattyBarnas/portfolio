...
const About = () => {
  ...
  typewriter.typeString("A little bit about myself.").pauseFor(3000).start();
    ...
    <div className="about">
      ...
      >
        ...
        <p className="about-me-description">
          Hey there 👋, thank you for visiting my page. My name is Patryk and I
          enjoy solving problems writing code. I completed a Bachelor of
          Computer Science degree at Governors State University. Development has
          been a passion of mine ever since I was a young kid who was influenced
          by my uncle and brother who are also developers. Nowadays, I continue
          to challenge myself by learning and applying it to solve complex
          problems. It inspires me how coding can reach so many people, the
